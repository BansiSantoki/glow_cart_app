...
class Activity_Haircare : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ib6= findViewById(R.id.imageButton5)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.imageButton1 -> {
                val i=Intent(applicationContext, Activity_Hairsampoo::class.java)
                i.putExtra( "username",nm)//Pass username to Activity_Face
                startActivity(i)
            }
            R.id.imageButton2 -> {
                val i = Intent(applicationContext, Activity_Hairoil::class.java)
                i.putExtra("username", nm)//Pass username to Activity_Face
                startActivity(i)
            }
            R.id.imageButton3 -> {
                val i = Intent(applicationContext, Activity_Haircolor::class.java)
                i.putExtra("username", nm)//Pass username to Activity_Face
                startActivity(i)
            }
            R.id.imageButton4-> {
                val i = Intent(applicationContext, Activity_hairserum::class.java)
                i.putExtra("username", nm)//Pass username to Activity_Face
                startActivity(i)
            }
            R.id.imageButton5-> {
                val i = Intent(applicationContext, Activity_Hairspray::class.java)
                i.putExtra("username", nm)//Pass username to Activity_Face
                startActivity(i)
            }
            R.id.imageButton6-> {
                val i = Intent(applicationContext, Activity_Hairtools::class.java)
                i.putExtra("username", nm)//Pass username to Activity_Face
                startActivity(i)
            }
        }

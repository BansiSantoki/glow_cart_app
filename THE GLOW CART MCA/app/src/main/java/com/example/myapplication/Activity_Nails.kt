...
class Activity_Nails: AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.imageButton1 -> {
                val i=Intent(applicationContext, Activity_nailpaint::class.java)
                i.putExtra( "username",nm)//Pass username to Activity_Face
                startActivity(i)
            }
            R.id.imageButton2 -> {
                val i = Intent(applicationContext, Activity_nailremover::class.java)
                i.putExtra("username", nm)//Pass username to Activity_Face
                startActivity(i)
            }
            R.id.imageButton3 -> {
                val i = Intent(applicationContext, Activity_Nailtools::class.java)
                i.putExtra("username", nm)//Pass username to Activity_Face
                startActivity(i)
            }
            R.id.imageButton4-> {
                val i = Intent(applicationContext, Activity_Artificialnails::class.java)
                i.putExtra("username", nm)//Pass username to Activity_Face
                startActivity(i)
            }
        }

...
class Activity_Suncare : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.imageButton1 -> {
                val i=Intent(applicationContext, Activity_Facecream::class.java)
                i.putExtra( "username",nm)//Pass username to Activity_Face
                startActivity(i)
            }
            R.id.imageButton2 -> {
                val i = Intent(applicationContext, Activity_Bodycream::class.java)
                i.putExtra("username", nm)//Pass username to Activity_Face
                startActivity(i)
            }
